...
Ver · Escuchar · Responder — Impulsado por IA con Multi-LLMs
------------------------------------------------------------

Ve más allá del movimiento y la visión añadiendo **voz** e **IA**.  
Aquí explorarás texto a voz (TTS), voz a texto (STT) y grandes modelos de lenguaje (LLMs) para hacer que tu Fusion HAT hable, escuche e incluso converse contigo como un robot inteligente.
